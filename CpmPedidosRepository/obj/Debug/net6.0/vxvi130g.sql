...
CREATE TABLE tb_image_product (
    id_image integer NOT NULL,
    id_product integer NOT NULL,
    CONSTRAINT "PK_tb_image_product" PRIMARY KEY (id_image, id_product),
    CONSTRAINT "FK_tb_image_product_tb_imagem_id_image" FOREIGN KEY (id_image) REFERENCES tb_imagem ("Id") ON DELETE CASCADE,
    CONSTRAINT "FK_tb_image_product_tb_produto_id_product" FOREIGN KEY (id_product) REFERENCES tb_produto ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_tb_image_product_id_product" ON tb_image_product (id_product);
...
VALUES ('20221108202011_Init', '6.0.10');
